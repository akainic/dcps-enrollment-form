...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* This file has been modified from the original forked source code */
...
var Form = function (_Component) {
  ...
  function Form(props) {
    ...
    _this.onChange = function (formData) {
      _this.props.onChange(_extends({}, _this.state, { formData: formData }));
    };
    ...
    _this.onSubmit = function (event) {
      ...
      if (!_this.props.noValidate) {
        var _this$validate = _this.validate(_this.state.formData),
